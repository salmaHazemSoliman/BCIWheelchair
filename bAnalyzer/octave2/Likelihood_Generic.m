function TrainOut = Likelihood_Generic(directory, noiseFlag, idealFlag, butterFlag,NoneFilterFlag, f1FLag,f2FLag,f3FLag,f4FLag,f5FLag,f6FLag,LDAFLag,PCAFlag,CSP_LDAFlag,NoneFlag,startD,endD)
%{
