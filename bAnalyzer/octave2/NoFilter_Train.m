function [mu,Beta] = NoFilter_Train(data,HDR,startTime = 0,endTime = 4,operation = @mean,Mu_Min = 10,Mu_Max = 12,Beta_Min = 16,Beta_Max = 24)
    ...
    for k =1:length(HDR.TRIG)
      ...
      [mu(k,:) ,Beta(k,:)] = NoFilter(tempData,operation,fs,Mu_Min,Mu_Max,Beta_Min,Beta_Max);
